...
const CinemaSeatBooking = ({
  ...
  currency = "$",
  onBookingComplete = () => {},
  title = "Cinema Hall Boking",
  subTitle = "Select you prefered Seats",
}) => {
  /*=================================================================================*/
  ...
  const getSeatType = (row) => {
    ...
    console.log("seatTypeEntries:-", seatTypeEntries);
    console.log("row:-", row);
  ...
  console.log("getSeatType:-", getSeatType(2));
  ...
  const renderSeatSection = (seatRow, startIndex, endIndex) => {
    ...
    console.log(
      "seatRow with slice method:-",
      seatRow.slice(startIndex, endIndex)
    );
  ...
  return (
    <div className="w-full min-h-screen bg-grey-50 p-4">
      {/*========================================= tittle ========================================*/}
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-2xl lg:text-3xl font-bold text-center mb-2 text-grey-800">
          {title}
        </h1>
        <p className="text-center text-grey-600 mb-6">{subTitle}</p>
        {/*======================================== screen =========================================*/}

        <div className="mb-8">
          <div className="w-full h-4 bg-gradient-to-r from-gray-300 via-gray-400 to-gray-300 mb-2 rounded-lg shadow-inner" />
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="flex items-center">
            <div className="w-6 h-6 bg-green-400 border-2 border-green-500 rounded-t-lg mr-2"></div>{" "}
